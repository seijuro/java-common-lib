...
public class RecallTest {
     ...
     * @return
     */
    public boolean testRecallAPIResponsePaser() {
        try {
            ...
            RecallAPIResponseParser parser = new RecallAPIResponseParser(PublicDataAPIResponseJSONParser.InputType.TEXT, testSample);
            parser.parse();
     ...
     * @return
     */
    public static boolean testRecallAPIPageableResponsePaser() {
        try {
            ...
            RecallAPIResponseParser parser = new RecallAPIPageableResponseParser(PublicDataAPIResponseJSONParser.InputType.TEXT, testSample);
            parser.parse();
            PublicDataAPIResult result = parser.getResult();
    ...
    public static void main(String[] args) {
        ...
        assertTrue("Testing RecallAPIResponsePaser failed.", testApp.testRecallAPIResponsePaser());
        assertTrue("Testing RecallAPIPageableResponsePaser failed.", testApp.testRecallAPIPageableResponsePaser());
    }
}