...
public class RecallTest {
    public static JSONObject createSampleData() {
        try {
            ...
            JSONObject jsonSample = (JSONObject)parser.parse(jsonText);
    ...
    public static void main(String[] args) {
        ...
        JSONObject jsonSample = createSampleData();
        JSONArray contents = (JSONArray)jsonSample.get("content");

        final Gson gson = new Gson();
        for (Object content : contents) {
            Recall recall = gson.fromJson(content.toString(), Recall.class);

            recall.prettyPrint(System.out::println);
        }
    }
}