...
public class RecallTest {
    ...
    public static void main(String[] args) {
        RecallTest testApp = new RecallTest();

        assertTrue("The result of parsing RecallAPI result failed.", testApp.testRecallAPIResult() == true);
    }
}